...
{
    // enum, arrays, loops are shown at the bottom of the script
    ...
    internal class Program
    {
        ...
        static void players_turn()
        {
            ...
            else if (player.can_attack == true)
            {
                ...
                Console.WriteLine(" Gold: " + gold);
                Thread.Sleep(150);
                Console.WriteLine("\r\n Z to Attack      | Deal " + player.damage + " damage to the enemy, unless the enemy parries");
                Thread.Sleep(150);
                ...
                Thread.Sleep(150);
                Console.WriteLine(" C to Parry       | Costs 30 Stamina. If the enemy tries to attack, cancel their attack and stun them for the next turn. If the enemy tries to rob you, cancel their move instead");
                Thread.Sleep(150);
        ...
        static void enemys_turn(int players_move)
        {
            ...
            if (move == 1)
            {
                ...
                if (enemy.can_attack == true && parried <= 0)
                {
                    if (players_move == 4)
                    {
                        Thread.Sleep(800);
                        ...
                        Thread.Sleep(800);
                        health_change((30 * progress * 0.5f) * 1.3f);
                    }
                    else
                    {
                        Thread.Sleep(800);
                        Console.WriteLine(" The enemy attacks and dealt " + (int)(30 * progress * 0.5f) + " damage");
                        Thread.Sleep(800);
                        health_change(30 * progress * 0.5f);
                    }
                }
            }
            ...
            else if (move == 2)
            {
                if (players_move == 3)
                {
                    ...
                    Console.WriteLine(" But you parried the attack!");
                    Thread.Sleep(800);
                    Console.WriteLine(" The enemy couldn't move for this turn!");
                }
                else if (players_move == 1)
                {
                    Thread.Sleep(800);
            ...
            else
            {
                ...
                Thread.Sleep(800);
                int add_gold = (int)(rng.Next(20 * progress, 50 * progress));
        ...
        static void shop()
        {
            ...
            gold_change(0);
            Thread.Sleep(500);
            Console.WriteLine(" \r\n PRESS Z TO BUY: Health Potion | Generic rpg game health boost, gain +100 max health once bought ||| COST: " + (int)(200 * progress * 0.5f) + " gold");
            Thread.Sleep(500);
            Console.WriteLine(" \r\n PRESS X TO BUY: Attack Potion | Generic rpg game damage boost, gain +40 damage once bought ||| COST: " + (int)(200 * progress * 0.5f) + " gold");
            buy_something();
                ...
                switch (letter)
                {
                    case 'z':
                        if (gold > (int)(400 * progress * 0.5f))
                        {
                            ...
                            Thread.Sleep(500);
                            player.max_hp += 100;
                            gold -= (int)(200 * progress * 0.5f);
                            Console.WriteLine(" ▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒");
                            new_enemy();
                        }
                        else
                        {
                            Console.WriteLine(" sorry bud ya don't got enough gold... try robbing some more");
                            Console.WriteLine(" ▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒");
                            new_enemy();
                        }
                        return 0;
                    case 'x':
                        if (gold > (int)(400 * progress * 0.5f))
                        {
                            Console.WriteLine(" Your damage went up by 40");
                            Thread.Sleep(500);
                            player.damage += 40;
                            gold -= (int)(200 * progress * 0.5f);
                            Console.WriteLine(" ▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒");
